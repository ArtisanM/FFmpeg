...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=/Users/mo/Documents/FFmpeg/android/arm-v7a --disable-everything --disable-shared --disable-cuvid --disable-dxva2 --disable-ffnvcodec --disable-d3d11va --disable-nvdec --disable-nvenc --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-audiotoolbox --disable-amf --disable-doc --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avdevice --disable-swscale --disable-encoders --disable-decoders --disable-hwaccels --disable-parsers --disable-postproc --disable-indevs --disable-outdevs --disable-protocols --disable-filters --disable-bsfs --disable-doc --disable-indevs --disable-debug --disable-outdevs --disable-network --disable-runtime-cpudetect --enable-protocol=file --enable-cross-compile --enable-static --enable-neon --enable-small --enable-muxer='mp3,wav,adts,ipod,mov,mp4,pcm_s16le' --enable-demuxer='aac,ac3,amr*,pcm*,flac,eac3,mp3,wav,ape,mov,mpegps' --enable-encoder='aac,pcm_s16le' --enable-decoder='aac,pcm*,mp3*,adpcm*' --enable-decoder=ac3 --enable-decoder=alac --enable-decoder=alac_at --enable-decoder=amr_nb_at --enable-decoder=amrnb --enable-decoder=amrwb --enable-decoder=ape --enable-decoder=aptx --enable-decoder=aptx_hd --enable-decoder=libilbc --enable-decoder=libopencore_amrnb --enable-decoder=libopencore_amrwb --enable-decoder=libopus --enable-decoder=libvorbis --enable-decoder=mlp --enable-decoder=eac3 --enable-decoder=eac3_at --enable-decoder=vmdaudio --enable-decoder=wavpack --enable-decoder=flac --enable-decoder=wmav1 --enable-decoder=wmav2 --enable-parser=aac --enable-parser=ac3 --enable-parser=flac --enable-parser=opus --enable-parser=vorbis --enable-parser=mpegaudio --enable-bsf=aac_adtstoasc --enable-bsf=chomp --enable-bsf=dca_core --enable-bsf=dump_extradata --enable-bsf=eac3_core --enable-bsf=extract_extradata --enable-bsf=filter_units --enable-bsf=mp3_header_decompress --enable-bsf=null --enable-bsf=remove_extradata --enable-filter=acopy --enable-filter=acompressor --enable-filter=acontrast --enable-filter=acrossfade --enable-filter=acrusher --enable-filter=sofalizer --enable-filter=ladspa --enable-filter=abitscope --enable-filter=adelay --enable-filter=stereotools --enable-filter=highpass --enable-filter=hilbert --enable-filter=adrawgraph --enable-filter=aecho --enable-filter=flanger --enable-filter=aemphasis --enable-filter=join --enable-filter=abench --enable-filter=aeval --enable-filter=headphone --enable-filter=aevalsrc --enable-filter=afade --enable-filter=hdcd --enable-filter=haas --enable-filter=afftfilt --enable-filter=afifo --enable-filter=afir --enable-filter=stereowiden --enable-filter=superequalizer --enable-filter=surround --enable-filter=treble --enable-filter=tremolo --enable-filter=firequalizer --enable-filter=vibrato --enable-filter=aformat --enable-filter=ahistogram --enable-filter=aiir --enable-filter=ainterleave --enable-filter=alimiter --enable-filter=allpass --enable-filter=volume --enable-filter=volumedetect --enable-filter=aloop --enable-filter=amerge --enable-filter=crystalizer --enable-filter=ametadata --enable-filter=amix --enable-filter=amovie --enable-filter=dcshift --enable-filter=drmeter --enable-filter=dynaudnorm --enable-filter=replaygain --enable-filter=resample --enable-filter=rubberband --enable-filter=anoisesrc --enable-filter=anull --enable-filter=anullsink --enable-filter=crossfeed --enable-filter=anullsrc --enable-filter=extrastereo --enable-filter=apad --enable-filter=aperms --enable-filter=aphasemeter --enable-filter=aphaser --enable-filter=sidechaincompress --enable-filter=ebur128 --enable-filter=equalizer --enable-filter=sidechaingate --enable-filter=silencedetect --enable-filter=silenceremove --enable-filter=sine --enable-filter=arealtime --enable-filter=asendcmd --enable-filter=asetnsamples --enable-filter=asetpts --enable-filter=asetrate --enable-filter=earwax --enable-filter=asettb --enable-filter=ashowinfo --enable-filter=asidedata --enable-filter=asplit --enable-filter=atempo --enable-filter=atrim --enable-filter=avectorscope --enable-filter=bandpass --enable-filter=bandreject --enable-filter=biquad --enable-filter=channelmap --enable-filter=chorus --enable-filter=compensationdelay --enable-filter=concat --enable-filter=compand --enable-filter=channelsplit --enable-filter=bs2b --enable-filter=bass --enable-filter=loudnorm --enable-filter=lowpass --enable-filter=lv2 --enable-filter=mcompand --enable-filter=pan --enable-filter=astreamselect --enable-filter=astats --enable-filter=aselect --enable-filter=areverse --enable-filter=aresample --enable-filter=apulsator --enable-filter=anequalizer --enable-filter=agate --cross-prefix=/Users/mo/Documents/work/Android/ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --arch=arm --sysroot=/Users/mo/Documents/work/Android/ndk/platforms/android-18/arch-arm --extra-cflags='-I/Users/mo/Documents/work/Android/ndk/sysroot/usr/include/arm-linux-androideabi -I/usr/local/include -isysroot /Users/mo/Documents/work/Android/ndk/sysroot -D__ANDROID_API__=18 -U_FILE_OFFSET_BITS -Os -fPIC -DANDROID -Wno-deprecated -mfloat-abi=softfp -marm' --extra-ldflags="
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/mo/Documents/FFmpeg/android/arm-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/Users/mo/Documents/FFmpeg/android/arm-v7a/share/ffmpeg"
