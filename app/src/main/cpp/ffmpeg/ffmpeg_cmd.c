...
Java_mo_example_ffmpeg_ffmpegdemo_FFmpegCmd_exec(JNIEnv *env, jclass clazz, jint cmdnum, jobjectArray cmdline) {
...
Java_mo_example_ffmpeg_ffmpegdemo_FFmpegCmd_exit(JNIEnv *env, jclass type) {
    (*env)->GetJavaVM(env, &jvm);
